...
async def start(client, message):
    ...
    if await check_user_joined_channels(client, user_id, config.REQUIRED_CHANNEL_IDS):
        welcome_message = (
            ...
            "**☞ Rᴇɢɪsᴛᴇʀ Wɪᴛʜ https://bhrdream.xyz/#/register?invitationCode=37884841**\n\n"
            "**👋 Eᴀʀɴ Dᴀɪʟʏ 2000₹-5000₹ Vɪᴀ Pʟᴀʏɪɴɢ Eᴀsʏ Gᴀᴍᴇs💰**\n\n"
            "**ᴛʜᴀɴᴋ ʏᴏᴜ 😘😘**\n"
            "**────────────────────────────**"
        )
          
        photo_url = "https://telegra.ph/file/bee5eaf0854aac9e90518.jpg"
        reply_markup = InlineKeyboardMarkup([
            [InlineKeyboardButton("ʀᴇᴄʜᴀʀɢᴇ / ᴡɪᴛʜᴅʀᴀᴡᴀʟ ɪꜱꜱᴜᴇ", url="https://t.me/Mirasupportt")],
            [InlineKeyboardButton("ᴠɪᴘ ᴄʜᴀɴɴᴇʟ", url="https://t.me/+iWe8UHCWUX9jYmI1")],
